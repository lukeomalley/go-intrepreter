...
func TestCompilerScopes(t *testing.T) {
	...
	if last.Opcode != code.OpSub {
		t.Errorf("last instruction wrong. got=%d, want=%d", last.Opcode, code.OpSub)
	}
	...
	if len(compiler.scopes[compiler.scopeIndex].instructions) != 2 {
		t.Errorf("instructions length wrong. got=%d", compiler.scopes[compiler.scopeIndex].instructions)
	}
	...
	if previous.Opcode != code.OpMul {
		t.Errorf("previousInstruction wrong. got=%d, want=%d", previous.Opcode, code.OpMul)
	}
}
...
func testConstants(t *testing.T, expected []interface{}, actual []object.Object) error {
	...
	for i, constant := range expected {
		...
		case []code.Instructions:
			...
			if !ok {
				return fmt.Errorf("constand %d - not a function: %T", i, actual[i])
			}
...
func testStringObject(expected string, actual object.Object) error {
	...
	if !ok {
		return fmt.Errorf("object is now String. got=%T, (%+v)", actual, actual)
	}
